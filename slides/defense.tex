...
\begin{frame}
	...
	\begin{enumerate}
		...
		\item Диагностика (прогнозирование) болези;
...
\begin{frame}
	...
	\begin{mdframed}{}{ }
		\underline{Эффективность коллаборативных моделей по критерию стабильности}\\
			...
			то аксиомы выполняются и реализации функции ООМ и СОМ может
			гарантировать получение качественного решения. \\
	...
	\end{mdframed}
	 ...
	 \begin{mdframed}{}{}
		 ...
		 \begin{equation}\label{rt}
			 i \rt j  \Leftrightarrow \rhi(i, j) = \varepsilon_0,
			 \varepsilon_0 := 0
		 \end{equation}
	 \end{mdframed}
 }
...
\begin{frame}
	...
	\begin{mdframed}{}{ }
		\underline{Применение правила $\Pi_f$}
		\begin{enumerate}
			\item Качество решения зависит только от
			...
			\item Асимптотическая сложность алгоритмов решений на порядок меньше.
		\end{enumerate}
	\end{mdframed}
	}
\end{frame}
