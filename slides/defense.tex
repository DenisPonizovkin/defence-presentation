		...
		\begin{mdframed}{}{ }
			...
			\begin{columns}[T]
				...
				\hfill \break
					...
					\le N$,
				\hfill \break
					\\где $N'$ --- устанавливаемый параметр.
				\end{mdframed}
...
\begin{frame}
	...
	\begin{mdfr}[9cm]{}{}
		Выполнение достаточных условий зависит от выбора разработчиками\\
		$\rho_i$ и $\varepsilon_i$ или $\rho_u$ и $\varepsilon_u$.
			\footnote{
				\tiny{
